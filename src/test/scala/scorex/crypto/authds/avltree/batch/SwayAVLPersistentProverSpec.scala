...
// Copy of AVLStorageWithPersistentProverSpec, with modifications made for SwayDB implementation
class SwayAVLPersistentProverSpec extends AnyPropSpec with Matchers {
